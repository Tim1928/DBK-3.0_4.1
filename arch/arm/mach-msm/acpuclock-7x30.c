...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 432000, PLL_3, 5, 1, 122800000, 850, VDD_RAW(850) },
	{ 1, 486000, PLL_3, 5, 1, 122800000, 875, VDD_RAW(875) },
  	{ 1, 540000, PLL_3, 5, 1, 122800000, 900, VDD_RAW(900) },
  	{ 1, 594000, PLL_3, 5, 1, 122800000, 925, VDD_RAW(925) },
  	{ 1, 648000, PLL_3, 5, 1, 122800000, 950, VDD_RAW(950) },
  	{ 1, 702000, PLL_3, 5, 1, 122800000, 975, VDD_RAW(975) },
